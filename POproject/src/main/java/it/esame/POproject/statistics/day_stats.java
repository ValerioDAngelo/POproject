 ...
 */
	...
	public double CalcAvg () throws DivisionByZeroException { 
	...
	if (sum_days == 0) throw new DivisionByZeroException ("divisione per zero");
	...
	public double CalcDevst () throws DivisionByZeroException { 
	...
	if (Statsarray.size() == 0) throw new DivisionByZeroException ("divisione per zero");
	...
	public static ArrayList<Tweet> getStatsarray() {
		return Statsarray;
	}

	public static void setStatsarray(ArrayList<Tweet> statsarray) {
